...
txt_next = 'Начать'
txt_instruction = ('Проба Руфье — это нагрузочный тест, который определяет работоспособность сердца во время и после физических нагрузок.')

txt_title = 'Тест Руфье'
txt_name = 'Введите Ф.И.О. ↓'
txt_hintname = "0"
txt_hintage = "0"
txt_test1 = 'Лягте на спину и замерьте пульс за 15 секунд. Нажмите кнопку "Начать первый тест", чтобы запустить таймер.\nРезультат запишите в строке ниже. ↓'
